        ...
        await sendMail({
          ...
          html: `
            <div style="font-family:system-ui,Segoe UI,Arial">
              <h2>Rejected ❌</h2>
              <p>Your admin access request has been rejected by the owner.</p>
              <p>If you think this is a mistake, please contact support.</p>
              <p>Login page: <a href="${new URL("/admin/register", origin).toString()}">Admin Login</a></p>
            </div>
          `,
        });
      } catch (e: any) {
        console.error("ADMIN REJECT NOTIFY EMAIL FAILED:", e);
      }
    }

    return new NextResponse(
      `<html><body style="font-family:system-ui;padding:24px"><h2>Rejected ❌</h2><p>Admin request rejected for <b>${admin.email}</b>.</p></body></html>`,
